  ...
  <div
    ...
    <div class="w-1/2 pl-2 md:pl-0">
      <a
        ...
        href="#">
        <i class="fas fa-sun text-orange-600 pr-3" />
        Admin Day Mode
      </a>
    </div>
            ...
            <svg
              ...
              <g>
                <path
                  ...
                  0,5.8l53.9,53.9c0.8,0.8 1.8,1.2 2.9,1.2 1,0 2.1-0.4
                  2.9-1.2l53.9-53.9c1.7-1.6 1.7-4.2 0.1-5.8z" />
              </g>
            </svg>
          </button>
          <div
            id="userMenu"
            class="bg-white rounded shadow-md mt-2 absolute mt-12 top-0 right-0
            min-w-full overflow-auto z-30 invisible">
            <ul class="list-reset">
              <li>
                <a
                  href="#"
                  class="px-4 py-2 block text-gray-900 hover:bg-gray-400
    ...
    <div
      ...
      <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
        ...
        <li class="mr-6 my-2 md:my-0">
          <a
            href="#"
            class="block py-1 md:py-3 pl-1 align-middle text-gray-500
            no-underline hover:text-gray-900 border-b-2 border-white
            hover:border-pink-500">
            <i class="fas fa-tasks fa-fw mr-3" />
        ...
        <li class="mr-6 my-2 md:my-0">
          <a
            ...
            <i class="fa fa-envelope fa-fw mr-3" />
        ...
        <li class="mr-6 my-2 md:my-0">
          <a
            ...
            <i class="fas fa-chart-area fa-fw mr-3" />
        ...
        <li class="mr-6 my-2 md:my-0">
          <a
            ...
            <i class="fa fa-wallet fa-fw mr-3" />
      ...
      <div class="relative pull-right pl-4 pr-4 md:pr-0">
        <input
          type="search"
          placeholder="Search"
          class="w-full bg-gray-100 text-sm text-gray-800 transition border
          focus:outline-none focus:border-gray-700 rounded py-1 px-2 pl-10
